  ...
  <td style = "font-size: 24px;font-weight:bold;"align="center"id = "accfinal"> 1 </td>
              ...
              <tr>
                <td style = "text-align: center; font-size: 24px; padding-top:1%; font-weight: bold;"> Accuracy Modifiers <br>(stacks multiplicatively):</td>
                <td>
                  ...
                  <label><input class = "mod" type="checkbox" id="nihil" onclick="onClickHandler();"value="1.05" /> Nihil</label>
                  <label><input class = "mod" type="checkbox" id="def" onclick="onClickHandler()"value="1.03" /> Defender</label>
                  <label><input class = "mod" type="checkbox" id="med"  onclick="onClickHandler()"value="1.01" /> Extreme Dominion Medallion</label><br>
                  <label><input class = "mod" type="checkbox" id="inf"  onclick="onClickHandler()" value="1.02" /> Inferior Accuracy Scrimshaw</label>
                  <label><input class = "mod" type="checkbox" id="sup"  onclick="onClickHandler()" value="1.04" /> Superior Accuracy Scrimshaw</label>
                  <label><input class = "mod" type="checkbox" id="void" onclick="onClickHandler()"value="1.03" /> Void (any set)</label>
                  <label><input class = "mod" type="checkbox" id="might" onclick="onClickHandler()"value="1.14" /> Mighty Slayer Helmet</label>
                  <label><input type="checkbox" id="zeal" value = "1"/> Amulet of Zealots (reselect prayer if multi-stat prayer was chosen earlier)</label>
                  <!-- <label><input class = "mod" type="checkbox" id="ess" onclick = "calcAcc();" /> Berserk Blood Essence (treats overload options as regular extremes/supremes)</label> -->
                </td>
                <td>
                </td>
              </tr>
              <tr>
  <td style = "text-align: center; font-size: 24px; padding-top:1%; font-weight: bold;">
    Affinity/Hit Chance Modifiers </br>(stacks additively):
  </td>
                <td class = "table-bordered" style = "border-collapse: collapse;">
                  <label><input name = "aff" class = "aff" type="checkbox" id="quake" onclick="onClickHandler2()"value="2" /> Quake (1 min)</label>
                  <label><input name = "hit" type="checkbox" id="reap" value = "0"/> Reaper's Necklace (max stacks)</label>
                  <label><input name = "aff" class = "aff" type="checkbox" id="hammer" onclick="onClickHandler2()"value="5" /> Statius Warhammer Special (5 min)</label>
                  <label><input name = "aff" class = "aff" type="checkbox" id="bandos"  onclick="onClickHandler2()"value="3" /> Bandos Book Special (12 secs)</label>
                  <label><input name = "aff" class = "aff" type="checkbox" id="guthix"  onclick="onClickHandler2()" value="2" /> Guthix Staff Special (1 min)</label>
                  <label><input name = "aff" class = "aff" type="checkbox" id="hatchet"  onclick="onClickHandler2()" value="3" /> Dragon Hatchet Special </label>
                  <label><input name = "aff" class = "aff" type="checkbox" id="anchor" onclick="onClickHandler2()"value="3" /> Barrelchest Anchor Special </label>&nbsp;&nbsp;
                  <label><input name = "aff" class = "aff" type="checkbox" id="dagger" onclick="onClickHandler2()"value = "2"/> Bone dagger Special</label>
                  <label><input name = "hit" type="checkbox" id="ability" value = "0"/> Offensive Ultimate Ability</label>
                </td>
                <td>
                </td>
              </tr>
            ...
            <tbody>
              <tr>
                ...
                <td style="white-space: nowrap;font-size:20px;" width = "36%">
                  ...
                  <center>
                    <img style = "display: block;"height = "560" width = "350" style = "image-resolution: 72dpi; "id = "bossimg" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                  </center>
                  <table class = "table" style = "padding:0px; margin:0px;font-size: 8px; font-style: italic|bold;">
                    ...
                    <tbody>
                      <tr style = "font-size: 32px; font-weight: bold; text-align: center;">
                        <center>
  ...
  <iframe id="bossvid" width="1200" height="676" src="https://www.youtube.com/embed/g2NVY2mFv_0" frameborder="0" allowfullscreen></iframe>
                    </th>
                  </tr>
    </table>
  ...
  $("#sty, #bossname, #aura, #prayer, #potion, #zeal").change(function(){
    acc();
    zealot();
  });
